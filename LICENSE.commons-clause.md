...
- You may **not** offer Torii (or a derivative whose value derives
  substantially from Torii) as a paid product or paid hosted/managed
  service to third parties without a commercial licence from the
  Licensor.
- Bundling Torii into a larger product whose paid value clearly
  derives from other components is permitted, as long as the Torii
  portion itself is not the substantial source of paid value.

If you want to sell Torii as a service or product, contact the
